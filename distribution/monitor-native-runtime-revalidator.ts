...
const FACT_KEYS = ["keyId", "buildId", "compositionId", "certificateSha256", "manifestSha256", "archiveSha256", "envelopeSha256", "publicationSha256", "activationSha256", "adminPid", "adminDev", "adminIno", "adminSha256", "monitorPid", "monitorDev", "monitorIno", "monitorSha256"];
...
export async function revalidateMonitorNativeRuntime(input: {
    ...
    assertCommand(activate, "activate-monitor-server", { unit: "rz.target", config: ["/opt/rz/config/rz-admin.env", "/opt/rz/config/rz-monitor.env"] });
