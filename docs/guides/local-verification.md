...
| 3 | Automation and Reports acceptance — [Scheduled Report Product](../product/features/scheduled-report-automation/spec.md) and [UI contract](../ui/features/scheduled-report-automation.md) | **Closed locally.** The current `linux/amd64` Schedule schema-2 and Reports schema-3 Chromium manifests were executed at coordination commit `477ce326d9ccf16e5d0ea91532b77fb5b2cafede`, with dirty source state limited to unrelated `AGENTS.md`, source tree `64ddf36a328c7d008e995b15295d3282366172b997baa2b746614c60ee04f2f9`, and Chromium `120.0.6099.224-1~deb11u1`. | One implementation owner completed the Reports/Web slice; final Colima gates and visual review passed. | Schedule: `target/rz/schedule-form-browser/runs/20260910T172224Z-72061/manifest.json`, SHA-256 `d23a3d0e90886abd2bbc3784b7a7b83eb9a0fc16c7db432bf0953bd2270d9d7b`, binds seven run-step receipts and reviewed 1440x900/390x844 captures. Reports: `target/rz/reports-ui-state/runs/20260910T173039Z-77141/manifest.json`, SHA-256 `f36022e522cdd3558d594b1f9afd382996630b48bc732392c9e66c556d82d930`, binds four browser receipts, cancelled processing, preserved source hashes, delivery gap 15, two canonical 403 receipts (both SHA-256 `c1067e1f99e114495eeb289c5e78fbefa4334fd239f42bfcb842f25ec88fc6cb`), and four visually reviewed captures. | Current manifests prove the bounded manager/view-only Templates/Runs journeys, processing, partial, failure, retry, permission, and retained-evidence behavior. Later documentation-only commits do not change the executed runtime inputs; they are not claimed to match the manifest HEAD. Native systemd, confined native-host seccomp, deployed scheduling, production deployment, external delivery, and real production due-time execution remain **Not verified**. |
