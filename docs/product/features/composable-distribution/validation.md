...
| D27a | Change binding descriptor, inventory binding/file table, selected API source, stamped HTML or any emitted asset | Selected-Web/container validation rejects before staging; normalized digest and final stamped-file inventory must both agree |
