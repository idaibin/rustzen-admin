...
| D27a | Add/remove an inventory-v2 field; change or reorder routes, assets, module IDs, emitted/file tables, generated/output roots, binding descriptor, selected API source, stamped HTML or any emitted asset | Admin compile and selected-Web/container validation reject before staging; the exact 11-field metadata, canonical order, normalized digest and final stamped-file inventory must all agree |
