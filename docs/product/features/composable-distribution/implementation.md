...
| P7 | Direct Admin fetch-SSE and shell integration | Stream/parser/cancellation tests and real browser/proxy reconciliation | P7a auth/session authority is **Closed locally / Passed** at the source, review, and disposable Linux runtime layers: fresh schemas persist random session IDs and auth epochs; every protected request reloads the current session, enabled user and grants from one database snapshot; access writes repeat the actor check inside their transaction; logout revokes one session and revoke-all/password/status changes invalidate prior epochs. The final `linux/arm64` gate published `target/rz/admin-session-authority/current/manifest.json`, with `current` pointing to `runs/20260907T195007Z-46269`. Manifest SHA-256 `f21c04fffee92246fe04a6897eaf1b5da1c82051ae73b5c95c35434e55dce122` binds head `02905e54388fa863e2bdee4b5fa25701eba78dc3`, dirty source tree `c182002b33edc1ec2ba15478353c1da421c9bcb155aaceb6fb51294ff71f7919`, Admin binary `15f0177c5bbd435c10c7fd55adba870ebfcd0a10314260b39a0b9b10318e292d`, 20 exact receipts, all three passed phases, grant epochs `42→45→48`, and zero owned build/runtime containers after publication. P7b SSE and P7c Web remain pending; SSE, Web/browser, proxy, sustained-load, native-systemd and production-deployment behavior remain **Not verified**. |
