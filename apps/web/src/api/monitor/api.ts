...
export const monitorAPI = { ...monitorCoreAPI, notificationDelivery: () => apiRequest<NotificationDeliveryStatus>({ url: monitorNotificationAPIContract.notificationDelivery.path, silent: true }) };
