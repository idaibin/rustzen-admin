...
export const requiredBusinessProvenance = [
    ...
    "scripts/monitor-notify-business-browser-receipt.ts", "scripts/monitor-notify-business-cdp.ts", "scripts/monitor-notify-business-context.ts", "scripts/monitor-notify-business-pages.ts", "scripts/monitor-notify-business-provenance.ts",
